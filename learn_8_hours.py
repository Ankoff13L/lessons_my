...
# d = {}
# d['e'] = 'no' # добавляет пару "ключ:значение", т.е. 'e': 'no'
# d[100] = 5    # добавляет пару "ключ:значение", т.е. 100: 5
# print(d)

# for x in d:   # цикл for перебирает пары словаря d
#     print(x)  # выводит только ключи 
...
# for x in d:   # цикл for перебирает пары словаря d
#     print(x, d[x]) # выводит ключи и их значения
...
for x in d:   # цикл for перебирает пары словаря d
    print(d[x])  # выводит только значения 

...
a = []
n = int(input())           # юзер вводит нужное количество иттераций и int() преобразует тексь в число
for i in range(n):
    a.append(int(input())) # юзер вводит числа и метод .append() добавляет их в список
